...
const EsimPage = () => {
  ...
  // This is the correct script URL for the Yesim (eSIM) widget that you found.
  const widgetScript = `//tpwdg.com/content?trs=446991&shmarker=661841&locale=en&powered_by=true&color_button=%23f2685f&color_focused=%23f2685f&secondary=%23FFFFFF&dark=%2311100f&light=%23FFFFFF&special=%23C4C4C4&border_radius=0&plain=false&no_labels=true&promo_id=8588&campaign_id=541`;
          ...
          <div id="esim-widget-container" ref={containerRef} className="relative min-h-[300px]">
            {isLoading && (
              <div className="absolute inset-0 flex flex-col justify-center items-center bg-gray-50/50 rounded-lg">
                ...
                <p className="mt-4 text-gray-500">Loading eSIM search...</p>
              </div>
            )}
          </div>
        </div>
