...
const ServiceButton = ({ service }) => {
  ...
  const buttonContent = (
      ...
      <span className="mt-2 text-xs sm:text-sm md:text-base font-bold text-white text-center uppercase tracking-wide leading-tight">
            {service.label}
        </span>
      </>
  );
...
//   const buttonContent = (
//   <>
//   <motion.div animate={iconControls} className="leading-none">
//     <service.Icon className="h-24 w-24 text-white block" />
//   </motion.div>
//   <span className="text-xs font-bold text-white text-center uppercase tracking-wider leading-none -mt-9">
//     {service.label}
//   </span>
// </>
// );
...
//     onClick={!isLoading ? handleAnimatedClick : undefined}
//     onKeyPress={(e) => { if (!isLoading && e.key === 'Enter') handleAnimatedClick(e); }}
//     className={`group w-full h-32 flex flex-col items-center justify-center px-2 rounded-2xl shadow-lg transition-all duration-200 overflow-hidden cursor-pointer ring-4 ring-inset ring-white/75 ${service.colorClass} ${isLoading ? 'opacity-75 cursor-not-allowed' : ''}`}
//     // className={`group w-full h-28 flex flex-col items-center justify-center p-4 rounded-lg shadow-md transition-all duration-200 overflow-hidden cursor-pointer ${service.colorClass} ${isLoading ? 'opacity-75 cursor-not-allowed' : ''}`}
...
//         <motion.div animate={iconControls} className="leading-none flex items-center justify-center">
//           <service.Icon className="h-20 w-20 text-white block" />
//         </motion.div>
//         <span className="text-xs font-bold text-white text-center uppercase tracking-wider leading-none mt-1">
//           {service.label}
//         </span>
//       </div>
//     )}
